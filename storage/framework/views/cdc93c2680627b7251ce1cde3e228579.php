...
<div class="card">
            ...
            <table class=" table table-bordered table-striped table-hover datatable datatable-User">
                <thead>
                    <tr>
                        ...
                        <th>
                            <?php echo e(trans('cruds.user.fields.station')); ?>
    ...
    <?php if($user->email_verified_at): ?>
        <span class="badge badge-success"><?php echo e($user->email_verified_at); ?></span>
    <?php else: ?>
    ...
    <?php endif; ?>
                          ...
                          <td> 
    <?php if($user->salaire): ?>
        <span class="badge badge-success"><?php echo e($user->salaire); ?></span>
    <?php else: ?>
        <span class="badge badge-danger"><?php echo e(__('global.not_received')); ?></span>
    <?php endif; ?>
</td>

                            <td>
                                <?php echo e($user->station->nom ?? ''); ?>
