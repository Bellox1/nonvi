    ...
    <div class="card-body">
        <form method="POST" action="<?php echo e(route("admin.clients.update", [$client->id])); ?>" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control <?php echo e($errors->has('nom') ? 'is-invalid' : ''); ?>" type="text" name="nom" id="nom" value="<?php echo e(old('nom', $client->nom)); ?>" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control <?php echo e($errors->has('telephone') ? 'is-invalid' : ''); ?>" type="number" name="telephone" id="telephone" value="<?php echo e(old('telephone', $client->telephone)); ?>" step="1" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control <?php echo e($errors->has('email') ? 'is-invalid' : ''); ?>" type="email" name="email" id="email" value="<?php echo e(old('email', $client->email)); ?>" required>
