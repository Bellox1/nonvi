...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['url' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(config('app.url'))]); ?><?php echo e(config('app.name')); ?> <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
<?php $component->withAttributes([]); ?>
© <?php echo e(date('Y')); ?> <?php echo e("Nonvi voyage plus"); ?>. <?php echo app('translator')->get('Tous droits réservés.'); ?>
 <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
<?php /**PATH C:\Users\hp EliteBook 840 G5\Desktop\nonvi\resources\views/vendor/mail/html/message.blade.php ENDPATH**/ ?>