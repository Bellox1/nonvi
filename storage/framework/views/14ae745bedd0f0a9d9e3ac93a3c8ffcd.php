...
<div class="card">
    ...
    <div class="card-body">
        <form method="POST" action="<?php echo e(route("admin.users.update", [$user->id])); ?>" enctype="multipart/form-data">
            ...
            <div class="form-group">
                <label class="required" for="station_id"><?php echo e(trans('cruds.user.fields.station')); ?></label>
                <select class="form-control select2 <?php echo e($errors->has('station') ? 'is-invalid' : ''); ?>" name="station_id" id="station_id" required>
                    <?php $__currentLoopData = $stations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $id => $entry): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($id); ?>" <?php echo e((old('station_id') ? old('station_id') : $user->station->id ?? '') == $id ? 'selected' : ''); ?>><?php echo e($entry); ?></option>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </select>
                <?php if($errors->has('station')): ?>
                    <div class="invalid-feedback">
                        <?php echo e($errors->first('station')); ?>

                    </div>
                <?php endif; ?>
                <span class="help-block"><?php echo e(trans('cruds.user.fields.station_helper')); ?></span>
            </div>
            <div class="form-group">
