...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['url' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($actionUrl),'color' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($color)]); ?><?php echo e($actionText); ?> <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php else: ?>
<?php echo app('translator')->get('Cordialement'); ?>,<br><?php echo e(config('app.name')); ?>
...
<?php endif; ?>
<?php /**PATH C:\Users\hp EliteBook 840 G5\Desktop\nonvi\resources\views/vendor/notifications/email.blade.php ENDPATH**/ ?>