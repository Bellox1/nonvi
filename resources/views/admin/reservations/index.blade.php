            ...
            <table class=" table table-bordered table-striped table-hover datatable datatable-Reservation">
                <thead>
                    <tr>
                        ...
                        <th>
                            {{ trans('cruds.reservation.fields.heure_depart') }}
                        </th>
                        <th>
                            {{ trans('cruds.reservation.fields.nombre_tickets') }}
                        </th>
                        <th>
                            {{ trans('cruds.reservation.fields.moyen_paiement') }}
                        </th>
                        <th>
                            {{ trans('cruds.reservation.fields.statut') }}
                        </th>
                        <th>
                            {{ trans('cruds.reservation.fields.client') }}
                        </th>
                        <th>
                        ...
                        <th>
                            {{ trans('cruds.reservation.fields.station_depart') }}
                        </th>
                        <th>
                            {{ trans('cruds.reservation.fields.station_arrivee') }}
                        </th>
                        <th>
                            &nbsp;
                        </th>
                ...
                <tbody>
                    @foreach($reservations as $key => $reservation)
                        <tr data-entry-id="{{ $reservation->id }}">
                            ...
                            <td>
                                {{ App\Models\Reservation::MOYEN_PAIEMENT_SELECT[$reservation->moyen_paiement] ?? '' }}
                            </td>
                            <td>
                                {{ App\Models\Reservation::STATUT_SELECT[$reservation->statut] ?? '' }}
                            </td>
                            <td>
                            ...
                            <td>
                                {{ $reservation->station_depart->nom ?? '' }}
                            </td>
                            <td>
                                {{ $reservation->station_arrivee->nom ?? '' }}
                            </td>
                            <td>
