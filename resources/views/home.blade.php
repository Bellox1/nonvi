...
@section('scripts')
@parent
<script src="https://cdnjs.cloudflare.com/ajax/libs/Chart.js/2.5.0/Chart.min.js"></script>{!! $chart2->renderJs() !!}{!! $chart3->renderJs() !!}{!! $chart4->renderJs() !!}{!! $chart8->renderJs() !!}{!! $chart9->renderJs() !!}{!! $chart11->renderJs() !!}{!! $chart12->renderJs() !!}{!! $chart13->renderJs() !!}{!! $chart14->renderJs() !!}
@endsection