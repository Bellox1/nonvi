<div id="sidebar" class="c-sidebar c-sidebar-fixed c-sidebar-lg-show">
    ...
    <ul class="c-sidebar-nav">
        ...
        @can('user_management_access')
            <li class="c-sidebar-nav-dropdown {{ request()->is("admin/permissions*") ? "c-show" : "" }} {{ request()->is("admin/roles*") ? "c-show" : "" }} {{ request()->is("admin/users*") ? "c-show" : "" }} {{ request()->is("admin/clients*") ? "c-show" : "" }} {{ request()->is("admin/stations*") ? "c-show" : "" }} {{ request()->is("admin/produits*") ? "c-show" : "" }} {{ request()->is("admin/reservations*") ? "c-show" : "" }} {{ request()->is("admin/colis*") ? "c-show" : "" }} {{ request()->is("admin/audit-logs*") ? "c-show" : "" }}">
                ...
                <ul class="c-sidebar-nav-dropdown-items">
                    ...
                    @can('produit_access')
                        <li class="c-sidebar-nav-item">
                            <a href="{{ route("admin.produits.index") }}" class="c-sidebar-nav-link {{ request()->is("admin/produits") || request()->is("admin/produits/*") ? "c-active" : "" }}">
                    ...
                    @can('coli_access')
                        <li class="c-sidebar-nav-item">
                            <a href="{{ route("admin.colis.index") }}" class="c-sidebar-nav-link {{ request()->is("admin/colis") || request()->is("admin/colis/*") ? "c-active" : "" }}">
                                <i class="fa-fw fas fa-box-open c-sidebar-nav-icon">

                                </i>
                                {{ trans('cruds.coli.title') }}
                            </a>
                        </li>
                    @endcan
